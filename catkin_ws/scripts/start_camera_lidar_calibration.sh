...
CALIBRATION_FILE="${CALIBRATION_FILE:-$ROS_ROOT_DIR/catkin_ws/src/scout_pointcloud_accumulator/config/camera_lidar_calibration.yaml}"
...
mkdir -p "$LOG_DIR" "$(dirname "$CALIBRATION_FILE")"
rm -f "$PID_FILE"
